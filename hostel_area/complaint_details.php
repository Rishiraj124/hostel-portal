...
<?php 
    ...
    $query="UPDATE complaint_details SET complaint_status='approved',complaint_seen='seen' WHERE complaint_number='$complaint_number' ";
        ...
        $query1="INSERT INTO complaint_notifications(notification_id,warden_name,warden_message,complaint_status) "; 
        $query1.="VALUES('$complaint_number','$warden_name','$warden_message','approved') ";
   ...
   <?php
        ...
        if(isset($_POST['unapprove_complaint']))
    {
        $query="UPDATE complaint_details SET complaint_status='unapproved',complaint_seen='seen' WHERE complaint_number='$complaint_number' ";
              ...
              $query1="INSERT into complaint_notifications(notification_id,warden_name,warden_message,complaint_status) VALUES('$complaint_number','$warden_name','$warden_message','unapproved') ";
