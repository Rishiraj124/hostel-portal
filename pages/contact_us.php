    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col text-center">
          <h1 class="display-4 text-uppercase text-dark mb-0">
            <strong>Hostel warden details</strong>
          </h1>
          <div class="title-underline bg-warning"></div>
          <p class="mt-2 text-capitalize text-muted">About the wARDEENS</p>
        </div>
      ...
      <div class="row">
        ...
        <div class="col-md-6 col-lg-4 my-3">
          <div class="card">
            <img src="https://drive.google.com/file/d/17fr3-kcyRd6syoUvuklhCPFHtNo_H-rM/view?usp=sharing" alt="member" class="card-img-top">
            <div class="card-body">
              <h5 class="card-title text-capitalize">CHIEF WARDEN</h5>
              <p class="card-text">
                BISWAJIT SAHOO
              </p>
